...
class EventCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_category" do
    assert_difference('EventCategory.count') do
      post event_categories_url, params: { event_category: { descripcion: @event_category.descripcion, nombre: @event_category.nombre } }
    end
  ...
  test "should update event_category" do
    patch event_category_url(@event_category), params: { event_category: { descripcion: @event_category.descripcion, nombre: @event_category.nombre } }
