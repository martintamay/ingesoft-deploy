...
class EventCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_comment" do
    assert_difference('EventComment.count') do
      post event_comments_url, params: { event_comment: { comentario: @event_comment.comentario } }
    end
  ...
  test "should update event_comment" do
    patch event_comment_url(@event_comment), params: { event_comment: { comentario: @event_comment.comentario } }
